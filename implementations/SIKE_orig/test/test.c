...
int main(int argc, char *argv[])
{
  ...
  const char *arg434 = "SIKEp434";
  const char *arg503 = "SIKEp503";
  const char *arg610 = "SIKEp610";
  ...
  // Process the first argument to choose the SIKE parameter set
  if (!strcmp(argv[1], arg434))
  {
    params_raw = &SIKEp434;
  }
  else if (!strcmp(argv[1], arg503))
  {
    params_raw = &SIKEp503;
  }
  else if (!strcmp(argv[1], arg610))
  {
    params_raw = &SIKEp610;
  }
  ...
  // Check the second argument to determine the test to run
